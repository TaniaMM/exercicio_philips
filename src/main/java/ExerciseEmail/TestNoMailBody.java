...
public class TestNoMailBody extends BaseLogInOut {

	public static Logger log = LogManager.getLogger(BaseTest.class.getName());

	@Test
	public void testNoMailBody1() {

		String emailAddress = "exerciciophilips@gmail.com", emailTitle = "Ut enim ad minim veniam";
		...
		assertEquals(ep.emailTitle().getText(), "Ut enim ad minim veniam");
